...
//   language: string; // Language for transcription (en, ru, pl, etc.)
// }
...
// src/main/services/audio-capture.ts
// Обновление полного файла для поддержки параметра language
...
export function getAudioCaptureSettings(): AudioCaptureSettings {
  return { ...captureSettings };
}
